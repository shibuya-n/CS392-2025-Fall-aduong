...
public class MyMapOpenAddressing<V>
    ...
    @SuppressWarnings("unchecked")
    public MyMapOpenAddressing(int cap) {
        capacity = cap;
        keyCount = 0;
    ...
    private static void testBasicOperations() {
        ...
        MyMapOpenAddressing<Integer> map = new MyMapOpenAddressing<>(8);
    ...
    private static void testMultipleValues() {
        ...
        MyMapOpenAddressing<String> map = new MyMapOpenAddressing<>(8);
    ...
    private static void testEdgeCases() {
        ...
        MyMapOpenAddressing<Integer> map = new MyMapOpenAddressing<>(4); // Small capacity
