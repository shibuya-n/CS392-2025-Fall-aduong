...
public class FnTupl3Util {
	public static <T0, T1, T2> void System$out$print(FnTupl3<T0, T1, T2> tup) {
	...
	public static <T0 extends Comparable<T0>, T1 extends Comparable<T1>, T2 extends Comparable<T2>> int compare(
			FnTupl3<T0, T1, T2> tup1, FnTupl3<T0, T1, T2> tup2) {
		int sgn;
