...
public class FnA1sz<T> {
	...
	public FnList<T> listize() {
		return this.U0.listize(this);
	}

	public FnList<T> rlistize() {
		return this.U0.rlistize(this);
	}

	//
	public FnA1sz<T> mergeSort(ToIntBiFunction<T, T> cmp) {
		return this.U0.mergeSort(this, cmp);
	}

	//
	public FnA1sz<T> insertSort(ToIntBiFunction<T, T> cmp) {
